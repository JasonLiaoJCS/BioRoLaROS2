...
private:
    ...
    void handle_motion_sample(const rinbo_msgs::msg::MotorStateStamped::SharedPtr& msg,
        ...
        for (int i = 0; i < 6; i++) {
            ...
            control_velocity_[i] = velocity_filter_[i].update(actual_velocities[i], dt);
        }
