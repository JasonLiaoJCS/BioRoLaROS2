...
enum class Fault { None, MotorStale, PowerStale, Estop, Epoch, Heartbeat, Nan, Stuck, StuckVelocity };
...
INSTANTIATE_TEST_SUITE_P(IsolatedDomain,ManualWireTest,::testing::Values(
    ...
    Fault::Epoch,Fault::Heartbeat,Fault::Nan,Fault::Stuck,Fault::StuckVelocity));
