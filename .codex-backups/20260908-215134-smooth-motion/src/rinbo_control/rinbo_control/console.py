...
1 接通機器人：讓這台 Jetson 電腦能讀到腳的位置。
  ...
  已設定密碼時會自動登入，否則才詢問；這一步不送上電或動作指令。
    ...
    while True:
        ...
        try:
            ...
            if choice == '':
                continue
            if choice == '1':
                say('\n第 1 步｜接通機器人。已設定密碼會自動登入；這一步不送上電或動作指令。')
