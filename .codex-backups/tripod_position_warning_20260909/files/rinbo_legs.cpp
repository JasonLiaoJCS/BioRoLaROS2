...
int main(int argc, char** argv) {
    try {
        if (argc < 2) throw std::runtime_error(
            "Usage: rinbo_legs status [--json] | set LEG... | disable LEG... | enable LEG... | enable-all | tune-tripod [--dry-run] KEY=VALUE... | tune-motion KP KD K_FF FRICTION_PWM FADE_COUNTS_S");
