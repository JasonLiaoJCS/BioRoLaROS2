...
NiFpga_Bool ModuleIO::read_dir_(int index){
    NiFpga_Bool value;
    NiFpga_MergeStatus(&status_, NiFpga_ReadBool(fpga_session_, r_dir_[index], &value));
    return value;
}
