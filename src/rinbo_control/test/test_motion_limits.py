...
def test_presets_preview_apply_and_restore_never_use_hardware(tmp_path, monkeypatch):
    ...
    runtime.parameters['rinbo_standing']['safety.position_tolerance_counts'] = 200
    runtime.parameters['rinbo_cali']['safety.stop_timeout_s'] = 5
    runtime.parameters['rinbo_tripod_rslip']['max_pwm'] = 80
    outputs = []
    ...
    runtime.parameters['rinbo_standing']['safety.settle_time_s'] = .3
    runtime.parameters['rinbo_cali']['safety.stop_timeout_s'] = 5
    runtime.parameters['rinbo_tripod_rslip']['safety.enable_pwm_slew_limit'] = 1
